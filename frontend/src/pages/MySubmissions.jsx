...
const MySubmissions = () => {
    ...
    if (loading) return <DashboardLayout><div className="loading">Loading your history...</div></DashboardLayout>;

    return (
        <DashboardLayout>
            <div style={{ marginBottom: '40px' }}>
                <h1 style={{ fontSize: '32px', fontWeight: '800', marginBottom: '8px' }}>My Submissions</h1>
                        ...
                        {submissions.length > 0 ? (
                            submissions.map(sub => (
                                <tr key={sub._id} style={{ borderBottom: '1px solid var(--border-color)' }}>
                                    ...
                                    <td style={{ padding: '20px', fontSize: '14px', fontStyle: 'italic', color: 'var(--text-secondary)' }}>
