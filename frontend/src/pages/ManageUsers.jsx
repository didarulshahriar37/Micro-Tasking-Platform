...
const ManageUsers = () => {
    ...
    if (loading) return <DashboardLayout><div className="loading">Loading users...</div></DashboardLayout>;

    return (
        <DashboardLayout>
            <div style={{ marginBottom: '40px' }}>
                <h1 style={{ fontSize: '32px', fontWeight: '800', marginBottom: '8px' }}>Manage Users</h1>
